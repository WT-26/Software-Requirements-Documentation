...
The software will allow club leaders to manage club activities efficiently, submit and monitor budget requests in coordination with the university’s financial system, and reserve spaces for events through integration with the campus venue booking system. It also provides members with access to club information and events, fostering greater engagement. While this SRS outlines the complete system, future revisions may introduce enhanced analytics, mobile support, and expanded integration capabilities.

The key objectives of the system are to reduce manual administrative tasks, increase operational transparency, and promote student involvement. By aligning with the university’s broader goals of digital transformation, operational efficiency, and enhanced student experience, this software supports institutional strategies to modernize student services and encourage co-curricular participation.
